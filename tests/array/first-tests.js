QUnit.test("sFirst tests", function (assert) {
  ...
  assert.deepEqual(sFirst([3]), 3, 'first element of single member array selected');
  assert.deepEqual(sFirst([3],5), 3, 'first five elements of single member array selected');
