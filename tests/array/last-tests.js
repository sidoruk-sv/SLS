QUnit.test("sLast tests", function (assert) {
  ...
  assert.deepEqual(sLast([3]), 3, 'last element of single member array selected');
  assert.deepEqual(sLast([3], 5), 3, 'last five elements of single member array selected');
